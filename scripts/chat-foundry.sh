#!/usr/bin/env bash
#
# chat-foundry.sh - Quick chat test against Foundry via private APIM
#
# Usage:
...
DEPLOYMENT="${FOUNDRY_DEPLOYMENT:-gpt-4.1}"
...
URL="${APIM_ENDPOINT}/openai/deployments/${DEPLOYMENT}/chat/completions?api-version=${API_VERSION}"
