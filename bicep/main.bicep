...
@description('Azure VPN Client Application ID / Audience (Microsoft Entra ID). Default is the Microsoft-registered Azure VPN Client audience (all clouds). The legacy manually-registered Azure Public audience was 41b23e61-6c1e-4545-b367-cd054e0ed4b4. See https://learn.microsoft.com/en-us/azure/vpn-gateway/point-to-site-entra-gateway-update')
