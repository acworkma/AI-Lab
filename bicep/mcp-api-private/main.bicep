// MCP API for Private Azure API Management
//
// Exposes the MCP server (running in ACA) through the private APIM instance.
// Standard REST API operations with Entra ID JWT authentication.
// Copilot Studio connects via custom connector through Power Platform VNet delegation.
//
// Operations:
...
param apiDisplayName string = 'MCP API (Private)'
